...
const PLANS = [
  ...
  },
  {
    ...
    monthlyPrice: 9.99,
    annualPrice: 7.99,
    description: "Everything an independent artist needs to release with confidence.",
    features: [
    ...
    excluded: ["Unlimited analyses", "AI Mastering", "Curator CRM & Sync Pitcher"],
  ...
  },
  {
    ...
    monthlyPrice: 24.99,
    annualPrice: 19.99,
    description: "The full release machine. Unlimited power for serious artists.",
    features: [
      ...
      "Playlist Pitcher — 40+ curators",
      "Press Kit generator",
      "Pitch Deck generator (PDF)",
      "Tour Planner & Finance tracker",
      "Competitor Intel",
      "Collab Finder",
      "Link-in-Bio builder",
