...
const PLANS = [
  {
    ...
    features: [
      ...
      "Algorithm Outlook section only",
      "Playlist Pitch section only",
      "Results include watermark",
    ],
    excluded: [
      "PDF download",
      "Saved reports",
  ...
  },
  {
    ...
    excluded: ["Curator CRM", "Unlimited analyses"],
    cta: "Start Starter",
    highlighted: false,
  },
  {
  ...
  {
    id: "label",
    name: "Label and Management",
    monthlyPrice: 79.99,
    annualPrice: 63.99,
    description: "Built for teams and labels.",
    features: [
      "Everything in Pro",
